...
const scenarioTemplates = {
    ...
    // 55% Subtle/Expert Phishing
    subtle: [
        {
            type: 'Email',
            sender: 'IT Service Desk',
            subject: 'Action Required: SSO Certificate Update',
            body: 'Team,\n\nWe are updating our Single Sign-On (SSO) certificates to enhance security. All users must re-authenticate their devices before the close of business today to ensure uninterrupted access to internal systems.\n\nPlease authenticate here: https://sso-auth-internal.net/login\n\nFailure to complete this step may result in temporary lockout.\n\nIT Support Services',
            isPhish: true,
            difficulty: 'Expert',
            clues: [
                'Domain "sso-auth-internal.net" is external, not the company domain',
                'Creates a deadline ("close of business today")',
                'Generic "Team" greeting',
                'Threat of "lockout" to induce panic'
            ],
            funnyRebuttal: 'IT doesn\'t send random links for "certificate updates." That\'s now how certificates work! 📜',
            dramaLevel: 2
        },
        {
            type: 'Email',
            sender: 'DocuSign',
            subject: 'Please DocuSign: Amended Contract Agreement.pdf',
            body: 'Mike Sent you a document to review and sign.\n\nREVIEW DOCUMENT\n\nMike says: "Please sign this asap."\n\nPowered by DocuSign\n\nLink: http://docusign-secure-viewer.info/doc/18293\n\nDo Not Share This Email\nThis email contains a secure link to DocuSign. Please do not share this email, link, or access code with others.',
            isPhish: true,
            difficulty: 'Expert',
            clues: [
                'Domain "docusign-secure-viewer.info" is fake (real is docusign.net or docusign.com)',
                'Vague context ("Amended Contract Agreement")',
                'Generic sender name "Mike"',
                'Urgency "asap"'
            ],
            funnyRebuttal: 'Mike wants you to sign his "scam agreement." Check the URL before you sign your life away! ✍️',
            dramaLevel: 1
        },
        {
            type: 'Email',
    ...
    // 30% Safe/Legitimate Messages (Including Tricky Ones)
    safe: [
        {
            type: 'Email',
            sender: 'Google Security',
            subject: 'New sign-in on iPhone',
            body: 'Hi,\n\nNew sign-in on iPhone.\n\nYour Google Account was just signed in to from a new iPhone device. You\'re getting this email to make sure it was you.\n\nCheck activity: https://myaccount.google.com/notifications\n\nGoogle, Inc. | 1600 Amphitheatre Parkway, Mountain View, CA',
            isPhish: false,
            difficulty: 'Medium',
            clues: [
                'Legitimate domain "google.com"',
                'Does not ask for password or personal info directly',
                'Link directs to standard Google account page',
                'Standard security notification format',
                'No sense of panic or artificial urgency'
            ],
            funnyRebuttal: 'Don\'t be too paranoid! This is a real security alert. If it wasn\'t you, change your password there! 🛡️',
            dramaLevel: 1
        },
        {
            type: 'Email',
...
export function generateScenario() {
    ...
    // 15% funny, 55% subtle/expert, 30% safe
    if (rand < 0.15) {
        category = categories.FUNNY;
    } else if (rand < 0.70) {  // 0.15 + 0.55
